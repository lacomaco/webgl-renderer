...
export class ShaderProgram {
    ...
    static createShader(gl: WebGL2RenderingContext, shaderSource:string, shaderType: number,label?:string){
    ...
    static createProgram(gl: WebGL2RenderingContext, vertexShader: WebGLShader, fragmentShader: WebGLShader, label?:string){
